...
// The reader primitives live in a Flutter-free library so the
// standalone `bin/ntp_cli.dart` probe (plain Dart VM) can reach
// `defaultNtpExchange`'s monotonic dependency; re-exported here so
// the rest of the package keeps importing one clock library.
export 'monotonic_reader.dart';
